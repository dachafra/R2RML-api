...
import es.upm.fi.dia.oeg.rmlc.api.model.RMLCView;
import es.upm.fi.dia.oeg.rmlc.api.model.W3C_R2RML_Recommendation;
...
public class RMLCViewImpl extends LogicalTableImpl implements RMLCView {
	...
	RMLCViewImpl(RDF c, String sqlQuery) {
		super(c);
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof RMLCViewImpl))
			return false;

		RMLCViewImpl other = (RMLCViewImpl) obj;
		if (getNode() == null) {
